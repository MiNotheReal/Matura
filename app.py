...
app.config['SQLALCHEMY_DATABASE_URI'] = "sqlite:////home/MiNotheReal/mysite/database.db"
Bootstrap(app)
db = SQLAlchemy(app)
...
API_KEY = "RGAPI-xxx-xxx-xxxx-xxxx-xxxxxxxxx"
...
def login():
    ...
    if form.validate_on_submit():
        ...
        return render_template('login.html', form=form, Invalid=Invalid)
    return render_template('login.html', form=form, Invalid=Invalid)
